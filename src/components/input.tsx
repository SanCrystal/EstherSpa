...
const Input = (props:{label:string ,type:string,id:number,refI?:React.RefObject<HTMLInputElement>,refT?: React.RefObject<HTMLTextAreaElement>}) => {
    return ( <div>
        {props.type==="textarea" && <div className="py-2 flex flex-col gap-1 ">
        ...
        {props.type==="text" && <div className="py-2 flex flex-col gap-1 ">
            <label htmlFor={`${props.label}`}>{props.label}</label>
        ...
        {props.type==="email" && <div className="py-2 flex flex-col gap-1 ">
            <label htmlFor={`${props.label}`}>{props.label}</label>
